...
| Subtitle | Project: short_id (e.g. `PROJ-0042`) in monospace `var(--color-muted)`. Run: parent project's short_id + the absolute run-directory name (`PROJ-0042 / Run_2026-05-06T14-32`). |
